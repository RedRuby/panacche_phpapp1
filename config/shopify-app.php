...
return [
    ...
    */
    ...
    'app_name' => env('SHOPIFY_APP_NAME', 'PanaccheDesigns'),
    ...
    */
    ...
    'api_key' => env('SHOPIFY_API_KEY', 'fa698e4ead2c1195305e3cb9de6b1a76'),
    ...
    */
    ...
    'api_secret' => env('SHOPIFY_API_SECRET', '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'),
    ...
    */
    ...
    'api_scopes' => env('SHOPIFY_API_SCOPES', 'read_products,write_products,read_themes,read_content,write_content,read_product_listings,read_customers,write_customers,read_orders,write_script_tags'),
