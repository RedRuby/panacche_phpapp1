             ...
             <div class="completedTag">
                      ...
                      <div class="card-body p-3">
                         <div class="d-flex align-items-center mb-2">
                            <div class="author-info">
                               <p class="mb-0">Draft Order - Modern Home <i class="fas fa-exclamation-circle ml-1"></i></p>
                            </div>
                         </div>
                ...
                <div class="card-body p-3">
                         <div class="align-items-center mb-2">
                            <div class="author-info">
                               <p class="mb-0 float-left"><i class="fas fa-check-square mr-1"></i> Modern Home</p>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12 mb-4">
                    <div class="card addCancelDesignBox h-100">
                        <div class="card-body addCancelDesignBtns">
                            ...
                            {{--  <p class="card-text cancelNewDesign w-100">
                            <span><i class="fas fa-times-circle"></i></span>
                            <span>Cancel</span>
                            </p>  --}}
                        </div>
                        <div class="packageSelect w-100 px-3">
                            <p class="mb-2">Select the Panacche Service Type</p>
                            <button type="button" class="btn btn-primary loyalPkg text-left p-2 w-100 mb-3 rounded-0">LOYAL <i class="fas fa-angle-right ml-1 mt-1 float-right"></i></button>
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12 mb-3">
                                <div class="card">
                                    <a href="{{ env('Shop_URL') }}/pages/buy-design?id={{ $value->id }}">
                                        <div class="card-img projectImg">
                                            <img src="{{ $value->image_src }}" class="card-img cover-photo" alt="{{ ($value->image_alt != '') ? $value->image_alt : 'Recommended Design' }}">
                                        </div>
                                        <div class="card-body p-3">
                                            <div class="d-flex align-items-center mb-2">
                                                <div class="author-info">
